...
wham_noise=/n/work1/shi/ASR/trans_20230614/espnet/egs2/librimix/sot_asr1/data/wham_noise
...
#    fi
    ...
    ln -s ${ldir}/metadta_Libri3Mix_offset metadata/Libri3Mix_offset
    ...
    do
        ...
        python scripts/create_librimix_from_metadata.py \
            ...
            --wham_dir ${cdir}/data/wham_noise/wham_noise \
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    metadata_dir="data/LibriMix/libri_mix_single_offset/Libri3Mix/wav${sample_rate}/${min_or_max}/metadata"
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    for dset in dev test train; do
	    ...
	    <(<data/${dset}/text_spk2 cut -d" " -f 2- | awk '{$0=$0" <sc> "; print($0)}') \
	    <(<data/${dset}/text_spk3 cut -d" " -f 2-) > data/${dset}/text
